...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$7, 6, 2, 122);
    		},
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { style: 0, type: 1, disabled: 2 });
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			attr_dev(div, "class", "card svelte-1r151jn");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-2g8pni");
    			add_location(input0, file$5, 15, 6, 303);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-2g8pni");
    			add_location(label0, file$5, 16, 6, 410);
    			attr_dev(li0, "class", "svelte-2g8pni");
    			add_location(li0, file$5, 14, 4, 292);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-2g8pni");
    			add_location(input1, file$5, 19, 6, 463);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-2g8pni");
    			add_location(label1, file$5, 20, 6, 570);
    			attr_dev(li1, "class", "svelte-2g8pni");
    			add_location(li1, file$5, 18, 4, 452);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "num3");
    			attr_dev(input2, "name", "rating");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-2g8pni");
    			add_location(input2, file$5, 23, 6, 623);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-2g8pni");
    			add_location(label2, file$5, 24, 6, 730);
    			attr_dev(li2, "class", "svelte-2g8pni");
    			add_location(li2, file$5, 22, 4, 612);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "id", "num4");
    			attr_dev(input3, "name", "rating");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-2g8pni");
    			add_location(input3, file$5, 27, 6, 783);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-2g8pni");
    			add_location(label3, file$5, 28, 6, 890);
    			attr_dev(li3, "class", "svelte-2g8pni");
    			add_location(li3, file$5, 26, 4, 772);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "id", "num5");
    			attr_dev(input4, "name", "rating");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-2g8pni");
    			add_location(input4, file$5, 31, 6, 943);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-2g8pni");
    			add_location(label4, file$5, 32, 6, 1050);
    			attr_dev(li4, "class", "svelte-2g8pni");
    			add_location(li4, file$5, 30, 4, 932);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "id", "num6");
    			attr_dev(input5, "name", "rating");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-2g8pni");
    			add_location(input5, file$5, 35, 6, 1103);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-2g8pni");
    			add_location(label5, file$5, 36, 6, 1210);
    			attr_dev(li5, "class", "svelte-2g8pni");
    			add_location(li5, file$5, 34, 4, 1092);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "id", "num7");
    			attr_dev(input6, "name", "rating");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-2g8pni");
    			add_location(input6, file$5, 39, 6, 1263);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-2g8pni");
    			add_location(label6, file$5, 40, 6, 1370);
    			attr_dev(li6, "class", "svelte-2g8pni");
    			add_location(li6, file$5, 38, 4, 1252);
    			...
    			attr_dev(input7, "class", "svelte-2g8pni");
    			add_location(input7, file$5, 43, 6, 1423);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-2g8pni");
    			add_location(label7, file$5, 44, 6, 1530);
    			attr_dev(li7, "class", "svelte-2g8pni");
    			add_location(li7, file$5, 42, 4, 1412);
    			...
    			attr_dev(input8, "class", "svelte-2g8pni");
    			add_location(input8, file$5, 47, 6, 1583);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-2g8pni");
    			add_location(label8, file$5, 48, 6, 1690);
    			attr_dev(li8, "class", "svelte-2g8pni");
    			add_location(li8, file$5, 46, 4, 1572);
    			...
    			attr_dev(input9, "class", "svelte-2g8pni");
    			add_location(input9, file$5, 51, 6, 1743);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-2g8pni");
    			add_location(label9, file$5, 52, 6, 1853);
    			attr_dev(li9, "class", "svelte-2g8pni");
    			add_location(li9, file$5, 50, 4, 1732);
    			attr_dev(ul, "class", "rating svelte-2g8pni");
    			add_location(ul, file$5, 13, 2, 268);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (56:6) <Button disabled={btnDisabled} type={"submit"}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(56:6) <Button disabled={btnDisabled} type={\\\"submit\\\"}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-hbldff");
    			add_location(div, file$4, 58, 6, 1337);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "placeholder", "Tell us something");
    			attr_dev(input, "class", "svelte-hbldff");
    			add_location(input, file$4, 49, 6, 1102);
    			attr_dev(div, "class", "input-group svelte-hbldff");
    			add_location(div, file$4, 48, 4, 1070);
    			add_location(form, file$4, 47, 2, 1019);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	ratingselect.$on("rating-select", /*handleRating*/ ctx[4]);
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			h2.textContent = "How would you rate us?";
    			t1 = space();
    			create_component(ratingselect.$$.fragment);
    			t2 = space();
    			create_component(card.$$.fragment);
    			attr_dev(h2, "class", "svelte-hbldff");
    			add_location(h2, file$4, 43, 2, 919);
    			attr_dev(header, "class", "svelte-hbldff");
    			add_location(header, file$4, 42, 0, 908);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const handleInput = () => {
    		if (text.trim().length <= min) {
    			$$invalidate(2, message = `Text length must be min ${min}`);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 13, 2, 295);
    			attr_dev(button, "class", "close svelte-s2w90w");
    			add_location(button, file$3, 16, 2, 350);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$3, 17, 2, 426);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Card, FeedbackStore, item, handleDelete });
    ...
    // (8:0) {#each $FeedbackStore as fb (fb.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$2, 8, 2, 210);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:0) {#each $FeedbackStore as fb (fb.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let h41;
    	let t3;
    	let t4_value = parseFloat(/*average*/ ctx[0]).toFixed(2) + "";
    	let t4;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			add_location(h40, file$1, 9, 2, 233);
    			add_location(h41, file$1, 10, 2, 262);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*average*/ 1 && t4_value !== (t4_value = parseFloat(/*average*/ ctx[0]).toFixed(2) + "")) set_data_dev(t4, t4_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 6, 0, 211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
